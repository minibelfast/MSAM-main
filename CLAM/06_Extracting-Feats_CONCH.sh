...
DIR_RAW_DATA=/data2/TCGA-COADREAD/slides
DIR_EXP_DATA=/data2/TCGA-COADREAD/patches
...
MODEL_CKPT=/data2/TCGA-COADREAD/CONCH/pytorch_model.bin
...
CUDA_VISIBLE_DEVICES=0 python3 /data2/TCGA-COADREAD/CLAM/extract_features_fp.py \
    --arch ${ARCH} \
