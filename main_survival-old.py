...
parser.add_argument('--data_root_dir_titan', type=str, default="/data2/Mamba_convolution/dataset/TCGA_GBMZN2/20x_512px_0px_overlap/slide_features_titan", 
                    help='Data directory to Titan features')
parser.add_argument('--data_root_dir_uni', type=str, default="/data2/Mamba_convolution/dataset/TCGA_GBMZN2/20x_256px_0px_overlap/features_uni_v2", 
...
parser.add_argument('--data_root_dir', type=str, default="/data2/Mamba_convolution/dataset/TCGA_BLCA/feature/resnet50/", 
...
parser.add_argument('--split_dir', type=str, default='/data2/Mamba_convolution/split/TCGA_BLCA_survival_kfold', 
...
parser.add_argument('--model_type', type=str, choices=['mean_mil', 'max_mil', 'att_mil','trans_mil', 's4model','mamba_mil','mamba_attn',"msa_mil"], default='mamba_attn', 
                    help='type of model')
