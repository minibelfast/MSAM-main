...
def train(datasets: tuple, cur: int, args: Namespace):
    ...
    if args.model_type == 'mean_mil':
        ...
        model = MambaAttn(num_classes=args.n_classes,dropout=args.drop_out,act='gelu',in_dim=args.in_dim,survival = True, layer = args.mambamil_layer, rate = args.mambamil_rate, type = args.mambamil_type)
    ...
    print('Done!')
    model = torch.load(os.path.join(args.results_dir, "s_{}_checkpoint.pth".format(cur)),map_location=torch.device('cuda'))
